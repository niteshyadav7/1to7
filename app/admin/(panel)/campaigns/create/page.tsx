...
import {
  ...
  Copy, CopyPlus, ClipboardPaste, Sparkle, Calendar
} from 'lucide-react'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                rows={4}
                className="w-full bg-slate-950/70 border border-white/10 text-white text-sm rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none placeholder:text-slate-500 leading-relaxed"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                rows={4}
                className="w-full bg-slate-950/70 border border-white/10 text-white text-sm rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-500 resize-none placeholder:text-slate-500 leading-relaxed"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 pt-1">
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                rows={3}
                className="w-full bg-slate-950/70 border border-white/10 text-white text-sm rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none placeholder:text-slate-500 font-mono text-xs leading-relaxed"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onClick={(e) => e.currentTarget.showPicker?.()}
                className="bg-slate-950/70 border-white/10 !text-white h-11 text-sm rounded-xl [color-scheme:dark] cursor-pointer [&::-webkit-calendar-picker-indicator]:cursor-pointer [&::-webkit-calendar-picker-indicator]:opacity-90 hover:[&::-webkit-calendar-picker-indicator]:opacity-100 [&::-webkit-calendar-picker-indicator]:p-1.5 [&::-webkit-calendar-picker-indicator]:rounded-lg [&::-webkit-calendar-picker-indicator]:bg-white/10 hover:[&::-webkit-calendar-picker-indicator]:bg-white/20 transition-all"
              />
